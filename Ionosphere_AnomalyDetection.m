...
optimizer = 'BFGS';
s_class_BFGS = SVM_Opt_model(train_x, train_y,  'RBF', C, 0.5, 'QuadraticPenalty', optimizer)
...
template = [0:0.05:1];
figure, plot(FPR_lst_BFGS, TPR_lst_BFGS, 'linewidth', 2, 'MarkerSize',12)
hold on
plot(template, template, 'linewidth', 2, 'MarkerSize',12)
legend(txt2, 'baseline')
